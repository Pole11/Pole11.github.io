...
function mouseClicked() {
    if (ballKicked(ballx, bally)) { // TODO: make the click detection on a round surface
        bounceBall();
        incrementPoints();
    }
}
...
function ballKicked(x, y) {
    return mouseX > x - gsize * csize/1.5 && mouseX < x + gsize * csize/1.5 && mouseY > y - gsize * csize/1.5 && mouseY < y + gsize * csize/1.5;
}
